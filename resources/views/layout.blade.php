...
<head>
    <base href="/">
    <meta charset="UTF-8">
    <title>PanamaBudgeting</title>
    <script type="application/javascript" src="<% elixir('js/all.js') %>"></script>
    <link rel="stylesheet" href="/css/app.css"/>
    <link rel="stylesheet" href="<% elixir('css/all.css') %>"/>
</head>
<body ng-app="transactionApp" ng-controller="MainController" ng-init="getAuthenticatedUser()">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">PanamaBudgeting</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li ng-if="authenticatedUser != null" ng-class="{active:isActive('/transactions')}"><a href="/transactions">List Transactions</a></li>
                <li ng-if="authenticatedUser != null" ng-class="{active:isActive('/transactions/create')}"><a href="/transactions/create">Add Transaction</a></li>
